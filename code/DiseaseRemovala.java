 ...
 * @author Adr3
 */
public class DiseaseRemovala extends HttpServlet {
            ...
            int r=0;
              Connection con=ConnectionProvider.getConnection();
                         ...
                         catch(SQLException e)
                {
                 ...
                 RequestDispatcher rd2=request.getRequestDispatcher("removeDisease.jsp");
                if(r==0)
                {
                         out.println("<h1>Disease not Removed</h1>");
                ...
                if (r>0)
                {
                        ...
                        D.remove_Disease(obj_No);
                         out.println("<h1>Disease  Removed Successfully</h1>");
                         rd2.include(request, response);
